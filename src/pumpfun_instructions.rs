...
/// ✅ ساخت Buy Instruction با پشتیبانی Token2022
pub fn create_buy_instruction(
    ...
    // ✅ استفاده از token_program_id صحیح برای محاسبه bonding curve token account
    let bonding_curve_token_account = get_associated_token_address_with_program_id(bonding_curve, mint, token_program_id);
...
/// ✅ ساخت Sell Instruction با پشتیبانی Token2022
