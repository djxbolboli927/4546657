...
pub fn create_sell_instruction(
    ...
    // ✅ FIX: ترتیب اکانت‌ها مطابق با Solscan (index 8: ATA, index 9: creator_vault, index 10: token_program)
    let accounts = vec![
        ...
        AccountMeta::new(*bonding_curve_token_account, false),     // 4
        ...
        AccountMeta::new_readonly(associated_token_program, false), // 8 ← جدید!
        AccountMeta::new(*creator_vault, false),                   // 9
        AccountMeta::new_readonly(*token_program_id, false),       // 10 ← جابجا شد!
        AccountMeta::new_readonly(event_authority, false),         // 11
        AccountMeta::new_readonly(program_id, false),              // 12
        AccountMeta::new(global_volume, false),                    // 13
        AccountMeta::new(user_volume_accumulator, false),          // 14
        AccountMeta::new_readonly(fee_config, false),              // 15
        AccountMeta::new_readonly(fee_program, false),             // 16
    ];
