...
use std::str::FromStr;
use crate::spl_utils::{get_associated_token_address, TOKEN_PROGRAM_ID};
...
// ═══════════════════════════════════════════════════════════
// ✅ PDA Derivation Functions - فقط موارد لازم!
// ═══════════════════════════════════════════════════════════
...
pub fn create_buy_instruction(
    ...
    let bonding_curve_token_account = get_associated_token_address(bonding_curve, mint);
